...
\begin{figure}[H]
	...
	\subfloat[Detection of the table and the balls.]{
		...
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g2_c1.jpg}
	}
	\
	\subfloat[Transformation of the table to the minimap table size.]{
		%\label{fig:game2_clip1_mask}
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g2_c1_mask.jpg}
	}
...
\begin{figure}[H]
	...
	\subfloat[Detection of the table and the balls.]{
		...
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g3_c1.jpg}
	}
	\
	\subfloat[Transformation of the table to the minimap table size.]{
		%\label{fig:game3_clip1_mask}
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g3_c1_mask.jpg}
	}
...
\begin{figure}[H]
	...
	\subfloat[Detection of the table and the balls.]{
		...
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g4_c1.jpg}
	}
	\
	\subfloat[Transformation of the table to the minimap table size.]{
		%\label{fig:game4_clip1_mask}
		\includegraphics[width=0.35\textwidth]{images/TableOrientation/g4_c1_mask.jpg}
	}
